...
import utility.java.Base_Class;
import utility.java.Driverclass;
import utility.java.LoadProperties;
...
@BeforeTest
	...
	public void LaunchBrowser(String browserName) throws IOException {
		/*String browser
		 * LoadProperties Lp = new LoadProperties(); Lp.propertiesread();
		...
		/*
		 * Driverclass d = new Driverclass(driver); d.driverin(browser);
		 */
	...
	public void testmain() throws IOException {
		...
		sendkeys(user, LoadProperties.Username); //b.excelRead("TData", 1, 0)

		WebElement passw = idLocator("password");
		sendkeys(passw, LoadProperties.Password);
	...
	public void createLead() throws InterruptedException {
		try {
			...
			WebElement FirstName = xpathlocator("//input[@id='createLeadForm_firstName']");
			
			sendkeys(FirstName,excelRead("TData", 1, 2));

			//WebElement LastName = driver.findElement(By.xpath("//input[@id='createLeadForm_lastName']"));
			WebElement LastName = xpathlocator("//input[@id='createLeadForm_lastName']");
